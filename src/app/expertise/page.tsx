    ...
    <main>
      ...
      <section className={styles.expertiseHero}>
        ...
        <div className="containerr">
          ...
          <p className="subtitle_2">Nour Attorneys specializes in commercial and business law within UAE, making it a leading business law firm in the region, renowned for its trusted legal services.</p>

          <Image src={"/expertise-element.svg"} alt="element" width={530}
          height={530}
          />
